class PresetConfig {
  ...
  static const List<double> electronic = [
    5.0,
    5.5,
    4.0,
    2.0,
  ...
  static const List<double> podcast = [
    0.0,
    0.0,
    -1.0,
    -2.0,
  ...
  static const List<double> movie = [
    3.0,
    4.0,
    3.0,
    2.0,
  ...
  static const List<double> gaming = [
    4.0,
    5.0,
    3.5,
    1.0,
  ...
  static const List<double> voice = [
    -1.0,
    -1.0,
    -1.5,
    -2.0,
  ...
  static const Map<String, PresetConfig> presets = {
    'flat': PresetConfig(
        ...
        bands: flat,
        bassBoost: 0.0,
        virtualizerStrength: 0.0),
    'rock': PresetConfig(
        name: 'rock',
        label: 'Rock',
        bands: rock,
        bassBoost: 0.6,
        virtualizerStrength: 0.4),
    'pop': PresetConfig(
        name: 'pop',
        label: 'Pop',
        bands: pop,
        bassBoost: 0.4,
        virtualizerStrength: 0.5),
    'jazz': PresetConfig(
        name: 'jazz',
        label: 'Jazz',
        bands: jazz,
    ...
    'classic': PresetConfig(
        ...
        bands: classic,
        bassBoost: 0.2,
        virtualizerStrength: 0.6),
    'electronic': PresetConfig(
        name: 'electronic',
        label: 'Electronic',
        bands: electronic,
        bassBoost: 0.8,
        virtualizerStrength: 0.65),
    'podcast': PresetConfig(
        name: 'podcast',
        label: 'Podcast',
        bands: podcast,
        bassBoost: 0.0,
        virtualizerStrength: 0.2),
    'movie': PresetConfig(
        name: 'movie',
        label: 'Movie',
        bands: movie,
        bassBoost: 0.7,
        virtualizerStrength: 0.8),
    'gaming': PresetConfig(
        name: 'gaming',
        label: 'Gaming',
        bands: gaming,
